...
<div class="place_with_price">
<!-- <h2>Add place with price</h2> -->
<form action="admin.php" method="post" >
<input type="number" name="price" class="price_input">
<input type="submit" value="Add place" name="price_submit" class="price_submit">
</form>
</div>



<div id="parking_locations">
